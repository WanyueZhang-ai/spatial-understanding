...
zero_shot_cot = "\nLet\'s think step by step before answering the question! And you should perform your step-by-step reasoning privately and not reveal it to the user. Only respond with the corresponding letter.\n"
...
visualize_attention(0, './output_qwen2.5_VL_7b-3/qwen2.5_7b_attention_image0-Implicit-Stepwise.png')
visualize_attention(1, './output_qwen2.5_VL_7b-3/qwen2.5_7b_attention_image1-Implicit-Stepwise.png')

os.makedirs('./output_qwen2.5_VL_7b_layers-3/', exist_ok=True)
visualize_attention_layers_separately(0, './output_qwen2.5_VL_7b_layers-3/image0-Implicit-Stepwise')
visualize_attention_layers_separately(1, './output_qwen2.5_VL_7b_layers-3/image1-Implicit-Stepwise')
