...
visualize_attention(0, './output_qwen2.5_VL_7b-3/qwen2.5_7b_attention_image0-Explicit-Multi-view-CoT.png')
visualize_attention(1, './output_qwen2.5_VL_7b-3/qwen2.5_7b_attention_image1-Explicit-Multi-view-CoT.png')

os.makedirs('./output_qwen2.5_VL_7b_layers-3/', exist_ok=True)
visualize_attention_layers_separately(0, './output_qwen2.5_VL_7b_layers-3/image0-Explicit-Multi-view-CoT')
visualize_attention_layers_separately(1, './output_qwen2.5_VL_7b_layers-3/image1-Explicit-Multi-view-CoT')
