...
zero_shot_cot = "\nLet's think step by step before answering the question! Please briefly show your reasoning process (within 500 words if possible), and conclude your answer in the format: 'The answer is A/B/C/D'."
...
messages_query = [{
    ...
    "content": [
        ...
        {"type": "text", "text": f"{question}{zero_shot_cot}"},
    ],
}]
...
def visualize_attention(img_index, save_path):
    ...
    title_text = f'Question: {question}{zero_shot_cot}'.replace('\n', '\\n')
...
visualize_attention(0, './output_qwen2.5_VL_7b-3/qwen2.5_7b_attention_image0-Explicit-Stepwise-CoT.png')
visualize_attention(1, './output_qwen2.5_VL_7b-3/qwen2.5_7b_attention_image1-Explicit-Stepwise-CoT.png')

os.makedirs('./output_qwen2.5_VL_7b_layers-3/', exist_ok=True)
visualize_attention_layers_separately(0, './output_qwen2.5_VL_7b_layers-3/image0-Explicit-Stepwise-CoT')
visualize_attention_layers_separately(1, './output_qwen2.5_VL_7b_layers-3/image1-Explicit-Stepwise-CoT')
